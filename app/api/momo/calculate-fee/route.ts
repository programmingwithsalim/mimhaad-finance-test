...
export async function POST(request: Request) {
  try {
    const { amount, provider, transaction_type, service_type } = await request.json()

    console.log("🧮 [FEE] Calculating fee for:", { amount, provider, transaction_type, service_type })
